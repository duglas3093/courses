...
class RoleController extends Controller
{
    ...
    public function update(Request $request, Role $role)
    {
        ...
        $role->permissions()->sync($request->permissions);//esto es igual a hacer un detach y un attach
        return redirect()->route('admin.roles.edit', $role)->with('info', 'El rol se modifico correctamente :D');
    }
