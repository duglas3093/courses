    ...
    <div class="container grid grid-cols-1 lg:grid-cols-3 gap-8">
        <div class="lg:col-span-2">
            ...
            <div class="flex justify-between mt-4">
                ...
                <div class="flex item-center cursor-pointer" wire:click="completed">
                    @if ($current->completed)
                        <i class="fas fa-toggle-on text-2x1 text-blue-600"></i>
                    @else
                        <i class="fas fa-toggle-off text-2x1 text-gray-600"></i>
                    @endif
                    <p class="text-sm ml2">Marcar esta unidad como culminada</p>
                </div>
                @if ($current->resource)
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="relative pt-1">
                    <div class="overflow-hidden h-2 mb-4 text-sm flex rounded bg-gray-200">
                        <div style="width:{{ $this->advance. '%' }}" class="shadow:none flex flex-col text-center whitescape-nowrap text-white justify-center bg-blue-500 transition-all duration-500"></div>
                    </div>
                </div>
                <ul>
