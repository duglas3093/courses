            ...
            <div class="card-body">
                @if ($lesson->id == $item->id)
                    <form wire:submit.prevent="update">
                        ...
                        <div class="mt-4 flex justify-end">
                            <button tpye="button"class="btn btn-danger" wire:click="cancel()">Cancelar</button>
                            <button tpye="submit"class="btn btn-primary ml-2">Actualizar</button>
                        </div>
                ...
                @else
                    ...
                    <div x-show="open">
                        ...
                        <p class="text-sm">Enlace: <a class="text-blue-600" href="{{ $item->url }}" target="__blank">{{ $item->url }}</a></p>
