<form class="pt-2 relative mx-auto text-gray-600" autocomplete="off">
    ...
    type="search" name="search" placeholder="Busccar">

    <button type="submyt" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded absolute right-0 top-0 mt-2">Buscar</button>
    @if ($search)
