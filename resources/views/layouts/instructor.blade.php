...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="font-sans antialiased">
        <div class="min-h-screen bg-gray-100">
            ...
            <!-- Page Content -->
                <div class="container p-8 grid grid-cols-5 gap-6">
                    <aside>
                        ...
                        <ul class="text-sm text-gray-600 mb-2">
                            ...
                            @if ($course->observation)
                                <li class="leading-7 mb-1 border-l-4 pl-2 @routeIs('instructor.courses.observation',$course) border-indigo-400 @else border-transparent @endif">
                        ...
                        @switch($course->status)
                            @case(1)
                                ...
                                @break
                            @case(2)
                                <div class="card text-yellow-700 ">
