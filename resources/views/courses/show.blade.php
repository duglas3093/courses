    ...
    <div class="container grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        @if (session('info'))
            <div class="lg:col-span-3">
                <div class="bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded relatile" >
            ...
            <aside class="hidden lg:block">
                @foreach ($similares as $similar)
                    <article class="flex mb-6">
                        ...
                        <img class="h-32 w-40 objet-cover" src="{{ asset('storage/'.$similar->image->url) }}" alt="">
                        <div class="ml-3">
                            <h1>
                                <a class="font-bolt text-gray-500 mb-3" href="{{ route('courses.show', $similar) }}">{{ Str::limit($similar->title, 40) }}</a>
                            </h1>
                            ...
                            <p class="text-sm"><i class="fa fa-star mr-2 text-yellow-400"></i>{{ $similar->rating }}</p>
                        </div>
                    </article>
                @endforeach
            </aside>
